...
const NavItems = ({ showNav, setHamburger, destination1, navItem1, destination2, navItem2, destination3, navItem3, destination4, navItem4 }) => {
    ...
    return (
        <ul className={`max-[767px]:fixed top-0 ${showNav} bottom-0 duration-500 bg-white/5 max-[767px]:backdrop-blur-2xl flex flex-col justify-center gap-y-12 max-[767px]:p-16 max-[767px]:h-screen 
