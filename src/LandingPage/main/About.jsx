...
const About = ({ aboutHeading1, aboutHeading2, aboutPara1, aboutPara2, aboutBtnText }) => {
    return (
        <section id="about" className="text-white px-5 min-[300px]:px-6 sm:px-12 md:px-18 lg:px-20 pt-28 pb-8 space-y-10 md:space-y-3 md:flex gap-14">
            <div className="flex-1">
                <h1 className="relative pl-3 mb-3 text-4xl font-bold before:bg-white before:w-1 before:h-[74%] before:absolute before:left-0 before:bottom-1 ">
                    <span className="text-lg font-medium text-sky-400">{aboutHeading1}</span><br />
                    {aboutHeading2}
                </h1>
